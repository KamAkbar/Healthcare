  ...
  <section class="activity">
      <div class="activity__row info row" v-for="(item, index) in clients" :key="index">
        ...
        <span class="activity__buttons row">
            <svg @click="openModal()" class="activity__open" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg @click="removeItem(item)" class="activity__remove" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style lang="scss">
    .activity{
        ...
        border-radius: 8px;
        padding: 24px;
        margin: 0 32px 38px 31px!important;
        &:hover{
